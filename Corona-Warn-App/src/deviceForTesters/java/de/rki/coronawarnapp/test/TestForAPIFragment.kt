...
class TestForAPIFragment : Fragment(), InternalExposureNotificationPermissionHelper.Callback {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val enableTestCountryAcme = test_api_switch_test_country as Switch
        enableTestCountryAcme.isChecked = LocalData.testCountryACME()
        enableTestCountryAcme.setOnClickListener {
            val isTestCountryACMEEnabled = enableTestCountryAcme.isChecked
            showToast("Test Country ACME is enabled: $isTestCountryACMEEnabled")
        }
